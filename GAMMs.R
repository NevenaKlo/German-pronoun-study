...
plot_diff(m1, 
          ...
          main = "Reflexive vs Pronoun (True)")
...
# ..............................................................................
# Inspect conditions separately and make plots for adults
# ..............................................................................

# Subset data for anaphor_true vs pronoun_true
adult_true <- droplevels(binned_data %>%
                           filter(condition %in% c("anaphor_true", "pronoun_true")))

# Subset data for anaphor_false vs pronoun_false
adult_false <- droplevels(binned_data %>%
                            filter(condition %in% c("anaphor_false", "pronoun_false")))

# Fit model for anaphor_true vs pronoun_true
m_adult_true <- bam(
  elogit ~ condition + s(Time, by = condition) +
    s(Participant, bs = 're') +
    s(Items, bs = 're'),
  data = adult_true,
  rho = r1,
...
# Fit model for anaphor_false vs pronoun_false
m_adult_false <- bam(
  elogit ~ condition + s(Time, by = condition) +
    s(Participant, bs = 're') +
    s(Items, bs = 're'),
...
plot_smooth(
  ...
  rug = FALSE,
  col = c("#009E73", "#CC79A7") ,
  main = "Adults: Anaphor vs Pronoun (True)",
...
plot_smooth(
  ...
  rug = FALSE,
  col = c("#E69F00", "#56B4E9"),
  main = "Adults: Anaphor vs Pronoun (False)",
  ylab = "Proportion of looks to Target"
)

# ..............................................................................
# Inspect conditions separately and make plots for children
# ..............................................................................

# Subset data for anaphor_true vs pronoun_true
children_true <- droplevels(binned_children %>%
                           filter(condition %in% c("anaphor_true", "pronoun_true")))

# Subset data for anaphor_false vs pronoun_false
children_false <- droplevels(binned_children %>%
                            filter(condition %in% c("anaphor_false", "pronoun_false")))
...
plot_smooth(
  ...
  rug = FALSE,
  col = c("#009E73", "#CC79A7") ,
  main = "Children: Anaphor vs Pronoun (True)",
  ylab = "Proportion of looks to Target"
)
...
plot_smooth(
  ...
  rug = FALSE,
  col = c("#E69F00", "#56B4E9"),
  main = "Children: Anaphor vs Pronoun (False)",
  ylab = "Proportion of looks to Target"
)